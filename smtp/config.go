...
type Config struct {
	...
	DKIMSelector, DKIMDomain, DKIMPrivateKeyPath                string
	RelayPort                                                   int
